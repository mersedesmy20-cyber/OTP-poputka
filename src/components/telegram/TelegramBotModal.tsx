  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'm1',
      sender: 'bot',
      text: `🧪 БЕТА-ТЕСТ | Їдемо Разом (ОТП Банк) 🚗💨\n\nВітаємо у корпоративному боті спільного використання авто для співробітників ОТП Банку (ГО Жилянська 43 та райони Києва)!\n\n⚠️ Зараз триває бета-тестування! Нам надзвичайно важливі ваша думка, відгуки та пропозиції.\n\n👇 Для запуску сервісу натисніть кнопку «🚀 Їдемо Разом» у лівому нижньому кутку чату або нижче!`,
      time: '09:45',
      showButton: true,
    }
  ]);
